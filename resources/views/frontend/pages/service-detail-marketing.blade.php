            ...
            <div class="row image-service">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="services-sm-image w-img mb-45">
                        <picture>
                            <source srcset="{{ asset('frontend/images/14.webp') }} 1x" type="image/webp">
                            <img src="{{ asset('frontend/images/14.jpg') }}"
                            alt="services-sm-img">
                           </picture>
                        </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="services-sm-image w-img mb-45">
                        <picture>
                            <source srcset="{{ asset('frontend/images/15.webp') }} 1x" type="image/webp">
                            <img src="{{ asset('frontend/images/15.jpg') }}"
                            alt="services-sm-img">
                           </picture>
                        </div>
                </div>

        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <a class="btn btn-sm btn-outline-secondary" href="{{route('blog.create')}}"><i class="fas fa-plus"></i> Ajouter Blog</a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Blog avec des fonctionnalités minimales et un style de survol
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
